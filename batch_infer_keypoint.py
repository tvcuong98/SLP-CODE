...
checkpoint_file="/home/edabk/Sleeping_pos/pretrained_HRpose_models/checkpoint_model_best.pth"
...
# Now you can iterate over batches of images and class labels using the dataloader
    ...
    for batch_img, batch_class,batch_img_path in dataloader:
        ...
        # This is for visualization 1 sample later on
            ...
            idx_test = "iter_{}_index_{}".format(iter,vs_index)  # image index
        ...
        for i in range(len(batch_img)):
            ...
            data_row.append(int(batch_class[i]))
            data_row.append(batch_img_path)
