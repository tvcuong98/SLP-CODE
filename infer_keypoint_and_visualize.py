...
import PIL.Image
csv_file_name="/home/edabk/Sleeping_pos/data/test_keypoint.csv"
opts_model="HRpose"
...
#checkpoint_file = "/home/edabk/new_SLP/gcn_classification_SLP/SLP_IR_u12_HRpose_exp_212/SLP_IR_u12_HRpose_exp/model_dump/checkpoint.pth"
    ...
    for class_i in range(8,10):
        ...
        for filename in os.listdir(os.path.join(root_dir,str(class_i))):
            if filename.endswith(".png"):
				...
				# batch version
                sv_dir="/home/edabk/new_SLP/gcn_classification_SLP/SLP-Dataset-and-Code/infer_kp_and_visual_output"
                mod0 = "IR"
                mean = [0.1924838]
                std = [0.077975444]
                img_patch_vis = ut.ts2cv2(inputs[0], mean, std) # to CV BGR
				# pseudo change
                cm = 11
