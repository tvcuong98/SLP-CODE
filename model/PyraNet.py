...
import model.modules.PyraNet as M
...
class PyraNet(nn.Module):
	...
	def __init__(self, nChannels=256, nStack=4, nModules=2, numReductions=4, baseWidth=6, cardinality=30, nJoints=16, inputRes=256, in_ch=3):
...
def get_pose_net(in_ch, out_ch, **kwargs):
	...
	model = PyraNet(256, 2, 2, 4, 6, 30, out_ch, 256, in_ch=in_ch)      # 256 hardfixed, if change, need to update  4 reduction, 4 baseWidth 30 cardinality
